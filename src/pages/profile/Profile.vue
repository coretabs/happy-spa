  ...
  <div>
    ...
    <div class="grayContentPage spaceFooter">
      ...
      <vue-data-loading
        ...
        @infinite-scroll="getPosts(false , false)"
        @pull-down="getPosts(true ,false)"
      >
        <div slot="completed" v-if="!posts.length > 0">لم ينشر اي منشور بعد</div>
          ...
          <div class="backgroundSend">
            <div class="bgTextSend bgTextAndImageSend">
              ...
              <ul class="communion center fullWidth">
                ...
                <li class="hand-Down">
                  <a :class="{bGolden: post.reaction == 'disliked'}" @click="dislikePost(post.id)">
