              ...
              <ul class="communion center fullWidth">
                <li>
                  <a @click="$router.push(`/comments?postid=${id}`)">
                    <span>{{ post.comments_count }}</span> <i class="question_answer"></i>
                  </a>
                </li>
                <li class="hand-Up">
                ...
                <li>
                  <a href="#">
                    <span>0</span> <i class="icon-reply"></i> 
                  </a>
                </li>
              </ul>
            </div>
...
>>>>>>> 7064cedee92e9dd1ba3b7b8b3591e373b2354608
                </div>
              </div>
              <div class="answerPara">
                <p>{{comment.content}}</p>
            ...
            <div class="communion">
              <a @click="likeComment(comment.id)"><span>{{comment.likes_count}}</span><i :class="{golden: comment.reaction == 'liked'}"
                  class="outline-thumb_up"></i></a>
              <a @click="dislikeComment(comment.id)"><span>{{comment.dislikes_count}}</span><i :class="{golden: comment.reaction == 'disliked'}"
                  class="outline-thumb_down"></i></a>
              <a @click="$router.push({ path : 'replies' , query : {postid : id , commentid : comment.id} })"><span>{{comment.replies_count}}</span><i
                  class="question_answer"></i></a>
              <a href="#" class="left headElements center CMTtime whiteGray">
                <span>{{comment.time_since}}</span>
              </a>
            </div>
            <div class="bodyAnswer reply" v-if="comment.top_reply">
              ...
              <div class="communion">
                <a @click="likeReply(comment.id)"><span>{{comment.top_reply.likes_count}}</span><i :class="{golden: comment.top_reply.reaction == 'liked'}"
                    class="outline-thumb_up"></i></a>
                <a @click="dislikeReply(comment.id)"><span>{{comment.top_reply.dislikes_count}}</span><i :class="{golden: comment.top_reply.reaction == 'disliked'}"
                    class="outline-thumb_down"></i></a>
                <a href="#" class="left headElements center CMTtime">
                  <span>{{comment.top_reply.time_since}}</span>
                </a>
      ...
      <footer class="bottomFooter box-shadow footerAndChat">
        ...
        <ul>
          <li>
            <router-link to='/home'><i class="home fontSize30"></i></router-link>
          </li>
          <li>
            <router-link to="#"><i class="notifications fontSize30"></i></router-link>
          </li>
          <li>
            <router-link to="/newpost"><i class="add plusIcon fontSize30"></i></router-link>
          </li>
          <li>
            <router-link to="#"><i class="explore fontSize28"></i></router-link>
          </li>
          <li>
            <router-link to="/profile"><i class="person fontSize30"></i></router-link>
          </li>
        </ul>
      </footer>
    </div>
