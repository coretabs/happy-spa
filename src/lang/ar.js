export const ar = {
    mixins: {
        CHKfull_name: 'الرجاء كتابة اسمك الاول و الاخير وتاريخ الميلاد',
    ...
    contactUs: {
        ...
        send: 'ارسال',
        required: 'مطلوب اسم المستخدم الخاص بك والبريد الإلكتروني وملاحظتك',
        check: 'الرجاء التحقق من اسم المستخدم وبريدك الالكتروني',
        characters3: 'يجب ان لا يقل عن 3 احرف',
        characters6: 'يجب ان لا يقل عن 6 احرف',
        thx: 'شكراً لتواصلك معنا',
        subjects: {
            forgot_password: 'نسيت كلمة السر',
            activation: 'لم تصلني رسالة التفعيل',
            Other: 'غير ذلك'
        }
    }
}